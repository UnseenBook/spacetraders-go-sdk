...
func (o *GetStatus200ResponseLeaderboardsMostCreditsInner) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetStatus200ResponseLeaderboardsMostCreditsInner)
